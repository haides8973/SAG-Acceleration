...
from diffusion_skip import logger, dist_util
...
def main():
    ...
    logger.configure(dir=f'RESULTS/{get_datetime()}')
    ...
    def model_fn(x, t, intermed_feat=None, first_t=False, y=None):
        assert y is not None
        return model(x, t, intermed_feat,first_t, y if args.class_cond else None)
